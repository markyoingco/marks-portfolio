...
export function contactLinkLine(
  label,
  display,
  href,
  { external = true } = {},
...
export function buildResumeSummaryCatOutput() {
  return buildFileCatOutput("summary.txt", [
    ...
    projectLine(
      "01",
      "Personal Portfolio Platform - React/Vite Web, Terminal & MarkAI Experience",
    ),
    ...
    bulletLine(
      "Team senior-capstone automated homework-evaluation/grading platform.",
    ),
    bulletLine(
...
export function buildContactLinkContent() {
  return [
    ...
    contactLinkLine(
      "GitHub",
      "github.com/markyoingco",
      "https://github.com/markyoingco",
    ),
    contactLinkLine(
      "LinkedIn",
    ...
    contactLinkLine(
      "Email",
      "markyoingco23@gmail.com",
      "mailto:markyoingco23@gmail.com",
      {
        external: false,
      },
    ),
